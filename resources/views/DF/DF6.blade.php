...
@section('result')
    ...
    <div style='width:80%' class='container mt-4'>
        ...
        @csrf
    @php
    showDFtable($MST,$Data,['Value','Importance','Baseline'],['dimension','importance','baseline'],6,$max,$version_name);
    ...
    <div class="container-fluid border bg-secondary text-center mt-5">
        <h3>Design Factor 6 {{$DFName}} Resulting Governance/Management Objetives Importance</h3>
    </div>
    @php
