...
@section('result')
    ...
    @php
    showDFtable($MST,$Data,['Value','Importance','Baseline'],['dimension','importance','baseline'],8);
    ...
    <div class="container-fluid border bg-secondary text-center mt-5">
        <h3>Design Factor 8 {{$DFName}} Resulting Governance/Management Objetives Importance</h3>
    </div>
    @php
